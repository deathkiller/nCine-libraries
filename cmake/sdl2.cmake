...
set(URL_SDL2 https://www.libsdl.org/release/SDL2-2.26.3.tar.gz)
set(URL_MD5_SDL2 6ff7cbe9f77fc5afa79d54895dc6becc)
...
elseif(APPLE)
	...
	ExternalProject_Add(project_${TARGET_SDL2}
		URL ${URL_SDL2}
		URL_MD5 ${URL_MD5_SDL2}
		CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_OSX_ARCHITECTURES="${CMAKE_OSX_ARCHITECTURES}"
